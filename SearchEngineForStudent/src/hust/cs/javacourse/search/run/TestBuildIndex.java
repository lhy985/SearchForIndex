...
public class TestBuildIndex {
    ...
    public static void main(String[] args){
        ...
        String rootDir = Config.DOC_DIR;//文件根目录
        ...
        //测试从文件读取
        AbstractIndex index1 = new Index();  //创建一个空的index
        index1.load(new File(indexFile));   // 从文件加载对象的内容
        System.out.println("\n Write current INDEX to file and then read from this file");
        System.out.println(index1); // 控制台打印index1的内容
