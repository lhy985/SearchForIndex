...
import hust.cs.javacourse.search.parse.impl.LengthTermTupleFiter;
...
public class DocumentBuilder extends AbstractDocumentBuilder {
    ...
    public AbstractDocument build(int docId, String docPath, File file) {
        ...
        try {
            termTupleStream = new LengthTermTupleFiter(new StopWordTermTupleFilter(new PatternTermTupleFilter(
